...
/* Se ascunde inputul după selectarea fișierului. */
...
/* În modal se afișează fișierul întreg. */
.site-modal-main img,
...
/* Schimbarea fișierului în același slot. */
.replace-wrap{
  min-height:44px;
  display:flex;
  align-items:center;
...
.replace-wrap input{display:none}
.replace-wrap:hover{color:var(--white)}
